...
function PlanCard() {
  return (
    <div className="h-[350px] w-full pointer mr-3 border rounded p-3">
      <div
        className="rounded bg-gradient-to-r from-cyan-500
            to-blue-500 w-full p-3 text-white font-bold"
      >
      ...
      <div className="border-b py-4 flex text-reg items-center">
        <div
          className="w-6 h-6 rounded-full text-sm bg-cyan-500 flex
